...
numtok_chain = {
	...
	'kant': [']', 'unan', 'daou', 'tri', 'pevar', 'pemp', "c'hwec'h", 'seizh', 'eizh', 'nav', 'dek', 'unnek', 'daouzek', 'trizek', 'pevarzek', 'pemzek', "c'hwezek", 'seitek', "triwec'h", 'naontek', 'ugent', 'tregont', 'hanter', 'mil', 'milion', '*'],
	"c'hant": [']', 'unan', 'daou', 'tri', 'pevar', 'pemp', "c'hwec'h", 'seizh', 'eizh', 'nav', 'dek', 'unnek', 'daouzek', 'trizek', 'pevarzek', 'pemzek', "c'hwezek", 'seitek', "triwec'h", 'naontek', 'ugent', 'tregont', 'hanter', 'mil', 'milion', '*'],
	'mil': [']', 'unan', 'daou', 'tri', 'pevar', 'pemp', "c'hwec'h", 'seizh', 'eizh', 'nav', 'dek', 'unnek', 'daouzek', 'trizek', 'pevarzek', 'pemzek', "c'hwezek", 'seitek', "triwec'h", 'naontek', 'ugent', 'tregont', 'hanter', 'kant', '*'],
	'vil': [']', 'unan', 'daou', 'tri', 'pevar', 'pemp', "c'hwec'h", 'seizh', 'eizh', 'nav', 'dek', 'unnek', 'daouzek', 'trizek', 'pevarzek', 'pemzek', "c'hwezek", 'seitek', "triwec'h", 'naontek', 'ugent', 'tregont', 'hanter', 'kant', '*'],
	'milion': [']', '*'], 'vilion': [']', '*'],
	'miliard': [']', '*'], 'viliard': [']', '*'],
