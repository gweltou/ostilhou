...
test_cases = [
    ...
    ("Ar skipailh 'n eus kavet 2 pe 3 zra talvoudus.", "Ar skipailh 'n eus kavet daou pe tri zra talvoudus."),
    ("ar bardelloù e Pariz mil pemp kant eizh ha pevar-ugent mil c'hwec'h kant eizh ha daou-ugent mil eizh kant tregont...",
        "ar bardelloù e Pariz 1588 1648 1830..."),
