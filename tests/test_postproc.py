...
from ostilhou.asr.post_processing import (
    post_process_timecoded,
    post_process_text,
)
...
test_cases = [
    ...
    ("An dra se hag an dra mañ", "An dra-se hag an dra-mañ"),
    # ("ar garantez se a zo pouezus tre", "ar garantez-se a zo pouezus-tre")
]
...
def test_post_process_timecoded():
    ...
    def should_be(s1: str, s2: str) -> None:
        tokens = post_process_timecoded(tokenize(s1), normalize=True, keep_fillers=False)
