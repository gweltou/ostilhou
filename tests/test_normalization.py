...
def test_normalization():
    ...
    test_cases = [
        ...
        ("da 4 c'hm eus kreiz Montroulez e c'houlenne ar rannvro 200 000€ o c'houzout e oa ivez goude evit 1M€ a labourioù",
            "da pevar c'hilometr eus kreiz Montroulez e c'houlenne ar rannvro daou c'hant mil euro o c'houzout e oa ivez goude evit ur milion euro a labourioù"),
