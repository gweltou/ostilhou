...
from ostilhou.asr import transcribe_segment, transcribe_file_timecoded, load_vosk
from ostilhou.audio import split_to_segments, load_audiofile, get_segment
...
if __name__ == "__main__":
    ...
    parser.add_argument('--padding', type=int, default=200,
                        help="Padding left and right (ms)")
    parser.add_argument("-m", "--model", help="Vosk model to use for decoding", metavar='MODEL_PATH')
    parser.add_argument('--min-sil-length', type=int, help="Minimum silence length", default=500)
    ...
    for segment in segments:
        ...
        seg.export(os.path.join(args.output, seg_name), format="wav")
