...
filepath, audio ext, seg start, seg end, reference, hypothesis

If using `output` argument, will skip already checked files.

usage:
    python3 ali_decode.py data.ali
    python3 ali_decode.py data_folder/ --model vosk_model/
    python3 ali_decode.py list_of_files.txt -o result.txt
"""
...
if __name__ == "__main__":
    ...
    for filepath in sorted(ali_files):
        ...
        for i in range(len(segments)):
            ...
            datapoint = (filepath, audio_ext, start, end, sentence, transcription)
